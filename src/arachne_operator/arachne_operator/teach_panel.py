...
class TeachPanelNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("base_replay_linear_speed", 0.06)
        self.declare_parameter("base_replay_angular_speed", 0.22)
        ...
        self.declare_parameter("arm_waypoint_duration_sec", 3.0)
        ...
        self.declare_parameter("recording_dir", "recordings")
