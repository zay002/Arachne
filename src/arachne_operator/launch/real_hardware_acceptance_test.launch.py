...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("arm_z_delta_m", default_value="0.04"),
            DeclareLaunchArgument("arm_z_frame", default_value="aubo_base"),
            DeclareLaunchArgument("arm_duration_sec", default_value="10.0"),
            DeclareLaunchArgument("arm_max_joint_delta", default_value="0.35"),
            ...
            DeclareLaunchArgument("arm_circle_radius_m", default_value="0.03"),
            DeclareLaunchArgument("arm_circle_points", default_value="48"),
            DeclareLaunchArgument("arm_circle_revolutions", default_value="1.0"),
            DeclareLaunchArgument("arm_circle_max_joint_delta", default_value="0.35"),
