...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("color_yuv_layout", default_value="YVYU"),
            ...
            DeclareLaunchArgument("camera_optical_roll", default_value="-1.57079632679"),
            DeclareLaunchArgument("camera_optical_pitch", default_value="0.0"),
            DeclareLaunchArgument("camera_optical_yaw", default_value="-1.57079632679"),
