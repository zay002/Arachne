...
REMOTE_PLANNER_URL="${ARACHNE_CONSOLE_REMOTE_PLANNER_URL:-${ARACHNE_REMOTE_PLANNER_URL:-}}"
REMOTE_PLANNER_TIMEOUT="${ARACHNE_CONSOLE_REMOTE_PLANNER_TIMEOUT:-${ARACHNE_REMOTE_PLANNER_TIMEOUT:-2.0}}"
DEFAULT_SERVER_EXTRA_ARGS="--moveit-planning-time 0.8 --moveit-service-timeout-padding 0.5 --moveit-planning-attempts 1 --no-moveit-local-first"
if [[ -n "${REMOTE_PLANNER_URL}" ]]; then
