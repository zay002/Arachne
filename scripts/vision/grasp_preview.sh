...
REAL_SEARCH_SCAN_LEFT_DELTA="${ARACHNE_GRASP_REAL_SEARCH_SCAN_LEFT_DELTA:--0.24,-0.04,-0.04,0.06,0.02,-0.21}"
REAL_SEARCH_SCAN_RIGHT_DELTA="${ARACHNE_GRASP_REAL_SEARCH_SCAN_RIGHT_DELTA:-0.24,0.02,0.04,-0.08,-0.02,0.23}"
